...
<head>
    ...
    <title>Home - Blood Donation Agent</title>
    <!-- Bootstrap CSS -->
...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="availability.php">Blood Availability</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container mt-5">
        <div class="jumbotron">
            ...
            <a class="btn btn-primary btn-lg" href="register.php" role="button"><i class="fas fa-heart"></i> Register as a Donor</a>
        </div>
    </div>
